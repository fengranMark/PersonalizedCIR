...
def main():
    ...
    with open(args.output_path) as f:
        for line_num,line in enumerate(f):
            ...
            prompt = f""" For an information-seeking dialog, Please select the user information that will help answer this the question(If there is any).
I will provide you with some examples:
{d}

""" + YourTask +'(Now you need to give me a list of the serial numbers you have chosen.The output format should always be:Provenance: $The user information number you have selected.'
            print(sample_id)
            print(prompt)
            r = openai.ChatCompletion.create(
                    model = model_engine,
                    messages = [{"role":"system","content":"you are a good information selector"},{"role":"user","content":prompt}])
